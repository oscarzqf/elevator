...
HD_PWD='D:/shudianshiyanpro/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter10_10_10_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter10_10_10_top.tcl -notrace
