...
HD_PWD='D:/shudianshiyanpro/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter10_10_10_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter10_10_10_top.tcl
