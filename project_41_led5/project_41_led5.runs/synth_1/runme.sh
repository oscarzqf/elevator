...
HD_PWD='D:/shudianshiyanpro/project_41_led5/project_41_led5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log elevatortop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source elevatortop.tcl
